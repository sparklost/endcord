...
keybindings = {
    ...
    "end_left": ("HOME", 526),
    "end_right": ("END", 527),
    "select_left": ("S-LEFT", 508),
    "select_right": ("S-RIGHT", 509),
    "select_word_left": ("C-S-LEFT", 510),
    "select_word_right": ("C-S-RIGHT", 511),
    "select_end_left": ("S-HOME", 528),
    "select_end_right": ("S-END", 529),
